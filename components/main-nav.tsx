...
const LogoImage = () => (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 816.8 651.3" width={80} height={80}>
    <polyline points="644.1 133.7 644.1 7.8 8.2 7.8 8.2 643.7 644.1 643.7 644.1 517.7" fill="none" stroke="#030063" strokeWidth={20}/>
      ...
      <div className="container mx-auto px-4">
        <div className="h-20 md:h-24 grid grid-cols-[1fr_auto] items-center">
          ...
          <div className="hidden md:flex items-end gap-4 justify-end">
            <NavigationMenu className="[&_[data-motion]]:!transform-none [&_[data-motion]]:!transition-none">
              <NavigationMenuList>
                <NavigationMenuItem>
